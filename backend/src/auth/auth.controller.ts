...
class RegisterDto { @IsString() @MaxLength(80) firstName!: string; @IsString() @MaxLength(80) lastName!: string; @IsEmail() email!: string; @Matches(/^0[567]\d{8}$/, { message: 'Phone must be a valid Algerian mobile number.' }) phone!: string; @IsString() @MinLength(10) password!: string; }
